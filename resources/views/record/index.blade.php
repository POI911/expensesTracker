                        ...
                        <div id="kt_content_container" style="overflow: scroll" {{-- class="container-xxl" --}}>
                            ...
                            <div class="card" style="overflow: scroll">
                                ...
                                <div class="card-body pt-0">
                                    <!--begin::Table-->
                                    <form id="bulk-delete-form" action="{{ route('records.bulkDelete') }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                                    ...
                                                    <th class="w-10px pe-2">
                                                        <div
                                                            ...
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                value="1" id="select-all-checkbox" />
                                                        </div>
                                                    </th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div
                                                                ...
                                                                <input class="form-check-input record-checkbox"
                                                                    type="checkbox" name="record_ids[]"
                                                                    value="{{ $record->id }}" />
                                                            </div>
                                                        </td>
                                                        <!--end::Checkbox-->
